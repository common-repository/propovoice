...
class Taxonomy {
    ...
    public function routes() {
        ...
        register_rest_route(
            'ndpv/v1', '/taxonomies' . ndpv()->plain_route(), [
				'methods' => 'GET',
				'callback' => [ $this, 'get' ],
				'permission_callback' => [ $this, 'get_per' ],
			]
        ...
        if ( $reg_errors->get_error_messages() ) {
            ...
            foreach ( $taxonomies as $taxonomy ) {
                ...
                if ( $id ) {
                    ...
                    $data[ 'single_' . $taxonomy ] = $tag_list;
                }
            }
    ...
    public function update( $req ) {
        ...
        if ( $reg_errors->get_error_messages() ) {
            ...
            if ( $add ) {
                ...
                if ( array_key_exists( $taxonomy, $taxonomy_actions ) ) {
					...
					if ( $action ) {
						do_action( 'ndpvp_webhook', $action, $param );
					}
                }

                do_action( 'ndpvp_webhook', 'taxonomy', $param );
