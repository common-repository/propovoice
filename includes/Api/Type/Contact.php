...
use Ndpv\Models\Deal;
use Ndpv\Models\Org;
use Ndpv\Models\Person;
use Ndpv\Models\Project;
...
class Contact {
    ...
    public function routes() {
        ...
        register_rest_route(
            'ndpv/v1', '/contacts' . ndpv()->plain_route(), [
				'methods' => 'GET',
				'callback' => [ $this, 'get' ],
				'permission_callback' => [ $this, 'get_per' ],
			]
    ...
    public function get_single( $req ) {
        ...
        if ( $type === 'org' ) {
            ...
            $org_id = isset( $query_meta['org_id'] )
                ? $query_meta['org_id'][0]
                : '';
            if ( $org_id ) {
                $org = new Org();
