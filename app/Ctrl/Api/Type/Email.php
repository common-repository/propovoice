...
class Email {
	...
	public function register_routes() {
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'delete_email_logs' ),
				'permission_callback' => array( $this, 'get_per' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'save_custom_email' ),
				'permission_callback' => array( $this, 'get_per' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'get_custom_email' ),
				'permission_callback' => array( $this, 'get_per' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array( $this, 'delete_custom_email_template' ),
				'permission_callback' => array( $this, 'get_per' ),
			)
		);
	}
	...
	public function sent( $param ) {
		...
		$subject  = Fns::templateVariable( $mail_subject, array() );
		$template = ndpv()->render( 'email/invoice', array(), true );
		...
		if ( $send_mail ) {
			...
			wp_send_json_error( array( 'Something wrong: Email not sent' ) );
		}
	}
	...
	public function dashboard( $param ) {
		...
		if ( $send_mail ) {
			...
			wp_send_json_error( array( 'Something wrong' ) );
		}
	}
